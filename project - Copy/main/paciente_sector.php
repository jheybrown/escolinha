...
$quarto= isset($_GET['quarto']) ? $_GET['quarto'] : die('ERROR: Record ID not found.');
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="bx bx-user-circle"></i>Sector - <span class="text-info"> <?php echo $quarto ?> </span></h4>
                                </div>
