...
$estado= isset($_GET['estado']) ? $_GET['estado'] : die('ERROR: Record ID not found.');
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="bx bx-user-circle"></i>Pacientes - <span class="text-info"> <?php echo $estado ?> </span></h4>
                                </div>
