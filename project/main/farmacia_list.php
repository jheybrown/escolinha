                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="bx 
bx-first-aid"></i>Gestão da Farmácia</h4>
                                </div>
  ...
  <li class="nav-item active">
    <a href="paciente_add.php" class="btn btn-success glow mr-1 mb-1"><i class="bx 
bx-first-aid"></i>
                                                    <span class="align-middle ml-25">Novo Medicamento</span></a>
  </li>
 </ul>
                                            </ol>
